...
/**
 * Created by dimion on 16/5/7.
 */
public class AnimationUtils {
    public static RotateAnimation
            initRotateAnimation(long duration, int fromAngle, int toAngle,
        ...
        mLoadingRotateAnimation.setInterpolator(new LinearInterpolator());
    ...
    public static AnimationDrawable initAnimationDrawable(Context context,
        ...
        for (int i = 0; i < drawableIds.length; i++) {
            ...
            mAnimationDrawable.addFrame(
                    context.getResources().getDrawable(id), durationTime);
        }
        mAnimationDrawable.setOneShot(isOneShot);
        return mAnimationDrawable;
    }

    public static Animation initAlphaAnimtion(Context context,
